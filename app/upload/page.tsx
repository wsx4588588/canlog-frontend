      ...
      <div className="max-w-md mx-auto text-center space-y-6 py-12 sm:py-20">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            {!isAuthenticated ? "請先登入以使用此功能" : "此功能僅限管理員使用"}
          </p>
        </div>
        <Button asChild>
          <Link href="/">返回首頁</Link>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="mx-auto w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center">
                    <Upload
                      className={`h-8 w-8 text-primary transition-transform ${isDragActive ? "scale-110" : ""}`}
                    />
                  </div>
                  <div>
                  ...
                  {(status === "success" || status === "error") && (
                    <>
                      ...
                      {status === "success" && result && (
                        <Button
                          onClick={() =>
                            router.push(`/canned-foods/${result.id}`)
                          }
                          className="flex-1"
                          size="lg"
                        >
        ...
        <div className="animate-fade-in animate-delay-200">
          {result ? (
            ...
            <Card className="h-full flex items-center justify-center min-h-[250px] sm:min-h-[400px]">
              <CardContent className="text-center space-y-4 py-8 sm:py-12">
